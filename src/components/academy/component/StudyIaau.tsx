  ...
  return (
    <Paper
      sx={{
        ...
        borderRadius: 2.2,
        border: `3px solid ${expanded ? MAIN : alpha(MAIN, 0.18)}`,
        background: alpha(theme.palette.background.paper, 0.92),
        boxShadow: expanded
          ? `0 18px 44px ${alpha(MAIN, 0.18)}`
    ...
    >
      ...
      <Box
        ...
        sx={{
          ...
          outline: "none",
          "&:focus-visible": {
            boxShadow: `0 0 0 4px ${alpha(MAIN, 0.22)}`,
          },
        }}
      >
        <Stack
...
export default function StudyResearchIaau() {
