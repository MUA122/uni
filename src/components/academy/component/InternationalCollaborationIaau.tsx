...
export default function InternationalCollaborationIaau() {
        ...
        >
          ...
          <Card
            sx={{
              ...
              border: `3px solid ${alpha(MAIN, 0.18)}`,
              ...
              >
                <Box
                  sx={{
                    ...
                    flexShrink: 0,
                    mr: 5,
                    boxShadow: `0 8px 18px ${alpha(MAIN, 0.28)}`,
                  }}
                >
                  2
                </Box>
                ...
                <Box
                  sx={{
                    ...
                    height: "50px",
                    borderRadius: 4,
                    background: `linear-gradient(180deg, ${MAIN} 0%, ${OTHER} 100%)`,
                    flexShrink: 0,
                  }}
                />
